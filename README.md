...
🕵🏻‍♂️ Inspect the `Debug Contracts` tab to figure out what address is the owner of GreenpillBRCollectible?

🔏 You can also check out your smart contract `GreenpillBRCollectible.sol` in `packages/hardhat/contracts`.
